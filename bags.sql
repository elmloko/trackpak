...
CREATE TABLE IF NOT EXISTS `bags` (
  ...
  `NRODESPACHO` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
...
) ENGINE=InnoDB AUTO_INCREMENT=9233 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
