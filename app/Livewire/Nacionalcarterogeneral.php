...
class Nacionalcarterogeneral extends Component
{
    use WithPagination;
    ...
    public function render()
    {
        ...
        $nationals = National::with('cartero') // Asegúrate de cargar la relación
        ...
        return view('livewire.nacionalcarterogeneral', [
            'nationals' => $nationals,
        ]);
    }
