...
class Deleteadoencomiendas extends Component
{
    ...
    public function mount()
    {
        ...
        Event::create([
            'action' => 'INGRESO',
            'descripcion' => 'Usuario ingresó a la pestaña "Inventario Paqueteria V7"',
    ...
    public function export()
    {
        ...
        return Excel::download(new InventarioencomiendaExport($this->fecha_inicio, $this->fecha_fin), 'Inventario Ordinario Encomiendas.xlsx');
    }
    ...
    public function generateKardex()
    {
        ...
        Event::create([
            'action' => 'ESTADO',
            'descripcion' => 'Generar Kardex Encomiendas',
            'user_id' => auth()->user()->id,
            'codigo' => 'N/A',
        ]);
        ...
        $internationalPackages = International::onlyTrashed()
            ...
            ->where('VENTANILLA', 'ENCOMIENDAS') // Filtrar por ventanilla 'DD'
