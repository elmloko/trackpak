...
class Casillasinventario extends Component
{
    ...
    public function mount()
    {
        ...
        Event::create([
            'action' => 'INGRESO',
            'descripcion' => 'Usuario ingresó a la pestaña "Inventario Paqueteria Casillas"',
    ...
    public function export()
    {
        ...
        return Excel::download(new InventarioCASIExport($this->fecha_inicio, $this->fecha_fin), 'Inventario Ordinario Casillas.xlsx');
    }
    ...
    public function reprintPDF($id)
    {
        ...
        if ($package) {
            ...
            return response()->streamDownload(function () use ($pdf) {
                echo $pdf->stream();
            }, 'Formulario Ordinario Casillas.pdf');
        } else {
