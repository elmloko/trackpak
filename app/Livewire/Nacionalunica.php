...
class Nacionalunica extends Component
{
    use WithPagination;
    ...
    {
        $userasignado = auth()->user()->regional;
        $nationals = National::where(function ($query) {
            ...
            ->whereIn('ESTADO', ['VENTANILLA'])
            // ->where('DESTINO', $userasignado)
        ...
        return view('livewire.nacionalunica', [
            'nationals' => $nationals,
        ]);
    }
