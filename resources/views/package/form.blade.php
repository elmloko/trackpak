            ...
            <div class="col-md-6">
                @hasrole('SuperAdmin|Administrador|Clasificacion|Auxiliar Clasificacion')
                    <div class="form-group">
                        ...
                        {{ Form::select('VENTANILLA', ['ECA' => 'ECA', 'UNICA' => 'UNICA', 'ENCOMIENDAS' => 'VENTANILLA 7', 'DND' => 'DND', 'DD' => 'DD', 'ECA' => 'ECA', 'CASILLAS' => 'CASILLAS', 'UNICA' => 'UNICA'], $package->VENTANILLA, ['class' => 'form-control' . ($errors->has('VENTANILLA') ? ' is-invalid' : ''), 'placeholder' => 'Selecione la Ventanilla', 'id' => 'ventanilla-select']) }}
