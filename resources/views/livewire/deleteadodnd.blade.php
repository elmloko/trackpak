                ...
                <div class="card-header" style="display: flex; justify-content: space-between; align-items: center;">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12">
                                <h5 id="card_title">
                                    {{ __('Inventario de Paquetes en Entregados en Ventanilla DND') }}
                                </h5>
                            </div>
                        </div>
                        <div class="row">
                                                ...
                                                <td>
                                                    <div class="btn-group" role="group">
                                                        @hasrole('SuperAdmin|Administrador')
                                                            <button wire:click="restorePackage({{ $package->id }})" class="btn btn-sm btn-info" style="margin-right: 10px;">
