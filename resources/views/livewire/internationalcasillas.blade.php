                            ...
                            <div class="row align-items-center">
                                <div class="col-md-12">
                                    <div class="row">
                                        ...
                                        <div class="col-md-5">
                                            <form method="get" action="{{ route('certificadoscasillas.excel') }}"
                                                class="col-md-12">
                                                @csrf
                                                <div class="form-row">
                                                    <div class="col-md-6">
                                        ...
                                        <div>
                                            <form wire:submit.prevent="import" class="form-inline">
                                                ...
                                                <a href="{{ route('plantillacasillas.excel') }}" class="btn btn-secondary mb-2 ml-2">Descargar Modelo Excel</a>
                                            </form>
